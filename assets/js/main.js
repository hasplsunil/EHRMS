...
/*function check(){
    ...
    var checkBox = document.getElementById("rs1");
    var checkBox = document.getElementById("rs2");

    for (var i=0; i < rs1.length; i++){
      if(checkBox.checked == true){
        rs1[i].style.display == "block";
        rs2[i].style.display == "none";
       }
       else if (checkBox.checked == false){
        rs1[i].style.display == "none";
        rs2[i].style.display == "block";
       }
    }
}
...
html
 <div class="top">
      <div class="toggle-btn">
         <span style="margin: 0.8em;" >IN INDIA</span>
         <label class="switch">
           <span></span>
           <input type="checkbox" id="checkbox" onclick="check()">
           <span class="slider round"></span>
         </label>
         <span style="margin: 0.8em;">REST OF INDIA</span>
      </div>
    </div>
css
.top {
